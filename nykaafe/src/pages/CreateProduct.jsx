...
function CreateProduct() {
    ...
    const [formData, setFormData] = useState({
        gender: 'demo', category: 'demo', subCategoryCloth: "demo", subCategoryShoes: "demo", subCategoryHandbag: 'demo',
        subCategorySunglass: "demo", subCategoryDesigners: 'demo', subCategoryJewelryWatch: 'demo', subCategoryAccessories: 'demo',
        title: '', brand_name: "", price: '', description: "", neck_type: "", dress_type: "", color: "", sleeve_type: "",
        material: "", wash: "", origin_countery: "", imgaes: [], discount: '', stock: "", size: [], rating: ''
    });
  ...
  return (
    <>
            {
                formData.length === 0 ? (<div className="loader"></div>) : (
                    <div className='register'>
                        <div style={{ width: '100%', display: 'flex', flexFlow: 'row wrap', justifyContent: 'space-between', border: 'none' }}>
                            <button onClick={() => navigate('/')} >HOME </button>
                            <button onClick={() => navigate('/userproduct', { state: { seller } })}  >PRODUCT LIST </button> </div>
                        <h1>CREATE PRODUCT</h1>
                        <h3 style={{ fontSize: '12px', color: 'burlywood' }}>CHOOSE ANY CATEGORY & THIER'S SUBATEGORY *</h3>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <input type="text" name="title" placeholder="Product Name unique" required
                            ...
                            <input type="text" name="origin_countery" placeholder="Origin countery" required
